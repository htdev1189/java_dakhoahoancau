    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2 justify-content-between">
                ...
                <div class="col-sm-1">
                    <a href="${pageContext.request.contextPath}/backend/post?action=add"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <jsp:useBean id="test" class="htdev.dao.CategoryDao"/>
                                                ${test.getCategoryByID(p.category).name}
                                        </td>
                                        <td>
                                            <img src="<c:url value='/upload/hinhanhbaiviet/${p.image}'/>"
                                                 class="img-fluid" style="width: 115px;height: 115px;">
                                        </td>
                                        <td>${p.name}</td>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/backend/post?action=edit&id=${p.id}"><i
                                                    class="far fa-edit"></i></a>
                                            <a onclick="return confirm('are you sure?');"
                                               href="${pageContext.request.contextPath}/backend/post?action=delete&id=${p.id}"><i
